...
export const LampContainer = ({ children, className }) => {
    return (
        <div
            className={cn(
                "relative flex min-h-screen flex-col items-center bg-slate-950 w-full rounded-md z-0 overflow-hidden",
                className
            )}
        >
            {/* Lamp Effect Header - More Visible */}
            ...
            {/* Content Area - overlaps with lamp for seamless look */}
